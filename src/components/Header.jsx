...
const Header = () => {
    ...
    return (
        <>
            <div className='h-14 shadow-md flex justify-between px-3 sm:px-16 items-center'>
                <div id='logo'>
                ...
                <div id='theme-mode'
                    className='relative flex items-end text-violet-700 font-semibold border-violet-700 px-2 py-0.5 rounded-md gap-1 cursor-pointer'
